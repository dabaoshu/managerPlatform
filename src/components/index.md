 ...
 * background: '#f0f2f5'
 */
import HeaderDropdown from '@/layouts/RightContent/components/HeaderDropdown';
 ...
 * background: '#f0f2f5'
 */
import HeaderSearch from '@/layouts/RightContent/components/HeaderSearch';
 ...
 * background: '#f0f2f5'
 */
import NoticeIcon from '@/layouts/RightContent/components/NoticeIcon/NoticeIcon';
...
<Space>
  ...
  {NODE_ENV && (
    <span>
      <Tag color={ENVTagColor[NODE_ENV]}>{NODE_ENV}</Tag>
    </span>
  )}
